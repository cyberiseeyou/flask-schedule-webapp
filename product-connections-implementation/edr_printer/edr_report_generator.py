...
Usage:
    ...
    generator.set_credentials("username", "password")
...
class EDRReportGenerator:
    ...
    def step2_request_mfa_code(self) -> bool:
        ...
        # Server will determine MFA method and send to registered device
        payload = {}
    ...
    def step3_validate_mfa_code(self, code: str) -> bool:
        ...
        # Server will validate against the current session
        payload = {
            "code": code,
            "failureCount": 0
        }
...
if __name__ == "__main__":
    ...
    print("   generator.set_credentials('username', 'password')")
